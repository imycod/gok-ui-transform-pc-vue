<template>
  <div class="fixed inset-x-0 navbar z-50">
    <nav class="relative shadow-lg bg-white px-4 py-4 flex justify-between items-center">
      <a class="text-3xl font-bold leading-none" href="#" v-if="false">
        ...
        <svg viewBox="0 0 45 45" id="logo" class="h-10" alt="logo">
          <path
              d="M35.4.4c-2.2 0-3.9.7-4.9 2.1C29.4 4 28.8 6.1 28.8 9v.2c-1.6-.7-3.4-1-5.3-1-2.6 0-4.9.6-7 1.6H16.2V9c0-2.9-.5-5-1.6-6.4S11.9.5 9.7.5C7.8.4 6.5 1 5.4 2c-1 1.1-1.5 2.5-1.5 4.4 0 2.4 2.4 5.1 7.3 8.3-2 3.2-3 7.1-3 11.9 0 5.7 1.4 10.1 4.3 13.2s6.8 4.7 11.9 4.7c2 0 3.9-.2 5.6-.5s3.5-.9 5.5-1.8v-2.9c-2.3.9-4.2 1.5-5.8 1.8-1.5.3-3.3.4-5.3.4-4.1 0-7.3-1.3-9.5-3.8s-3.3-6.2-3.4-11h25.3v-2.6c0-4-.8-7.3-2.4-10 4.4-3 6.6-5.6 6.6-7.9 0-1.9-.5-3.3-1.5-4.4-1-.8-2.3-1.4-4.1-1.4zM11.8 24c.2-3 1-5.6 2.1-7.6 1.1.7 2 1.3 2.7 1.9 2.3 1.6 4.3 3.2 5.9 4.7 1.7-1.5 3.6-3.1 5.9-4.7.9-.6 2-1.4 3.4-2.3 1.1 2.1 1.7 4.8 1.7 8H11.8z"></path>
        </svg>
      </a>
      <div class="flex items-center space-x-4" v-else>
        <img src="https://rafaelfragoso.com/content/images/2020/11/Logo.svg" alt="logo" class="w-10 h-10"/>
        <input type="text" name="search" placeholder="Pesquisar"
               class="px-3 py-3 shadow rounded w-80 hidden md:inline-block outline-none"/>
      </div>
      <div class="lg:hidden">
    ...
    <div class="navbar-menu relative z-50 hidden">
      ...
      <nav
        ...
        <div>
          <ul>
            <li class="mb-1" v-for="(navbar,index) in configNavbar" :key="index">
              <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
                 :class="active.value===navbar.path && 'bg-blue-50 text-blue-600'"
                 :href="navbar.path">{{ navbar.name }}</a>
            </li>
          </ul>
        </div>
        <div class="mt-auto">
