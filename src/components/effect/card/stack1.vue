...
<template>
  <div class="cards-box">
    ...
    <div class="card" v-for="(letter, idex) in list" :key="idex">
      <div class="content-placeholder">
        <div class="row">
          <div class="img" :data-letter="letter"></div>
          <div class="img-text"></div>
        </div>
        <div class="text text--l"></div>
        <div class="text text--m"></div>
...
body {
  background: linear-gradient(45deg, #d2f2e2, #c8e9d8);
  display: flex;
  align-items: center;
